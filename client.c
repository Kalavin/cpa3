...
main( int argc, char ** argv )
{
	...
	else
	{
		...
		else
		{
			...
			/*JEFF. Above pthreads I added 2 threads. 1 for writing and 1 for reading. Pretty sure
			  we can put all our code in just 1 thread to if we wanted to though.*/
			
			/*Below is the code he provided for our assignment. This while loop can probably
			  be used in our write thread and the read/write code in the while loop can be repurposed
